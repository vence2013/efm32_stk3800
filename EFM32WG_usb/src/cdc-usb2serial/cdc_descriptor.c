...
SL_ALIGN(4)
const USB_DeviceDescriptor_TypeDef USBDESC_cdc_device SL_ATTRIBUTE_ALIGN(4) =
{
...
SL_ALIGN(4)
const uint8_t USBDESC_cdc_config[] SL_ATTRIBUTE_ALIGN(4) =
{
...
const void * const USBDESC_cdc_strings[] =
{
  &langID,
  &iManufacturer,
  &iProduct,
...
const uint8_t USBDESC_cdc_bufferingMultiplier[NUM_EP_USED + 1] =
{
