...
SL_ALIGN(4)
const USB_DeviceDescriptor_TypeDef USBDESC_msc_device SL_ATTRIBUTE_ALIGN(4) =
{
...
#if 0
SL_ALIGN(4)
const uint8_t USBDESC_msc_config[] SL_ATTRIBUTE_ALIGN(4) =
{
...
const void * const USBDESC_msc_strings[] =
{
  &langID,
  &iManufacturer,
  &iProduct,
...
const uint8_t USBDESC_msc_bufferingMultiplier[NUM_EP_USED + 1] = { 1, 2, 2 };
#endif
